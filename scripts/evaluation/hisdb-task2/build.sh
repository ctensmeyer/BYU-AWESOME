...
tar -xvzf TranskribusBaseLineEvaluationScheme_v0.1.0.tar.gz

cd ..
mkdir built_jars

cp TranskribusBaseLineEvaluationScheme/TranskribusBaseLineEvaluationScheme_v0.1.0/TranskribusBaseLineEvaluationScheme-0.1.0-jar-with-dependencies.jar built_jars/baseline_evaluator.jar

cp TranskribusBaseLineEvaluationScheme/target/TranskribusBaseLineEvaluationScheme-0.1.0-jar-with-dependencies.jar built_jars/convert_xml.jar
