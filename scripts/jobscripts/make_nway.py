...
if len(sys.argv) < 5:
	print "python make_nway.py out_dir prefix dataset [net_dirs...]"
	exit()
...
for idx, f in enumerate(sys.argv[4:]):
	...
	with open(out_f, 'w') as out:
		...
		out.write("script=/fslhome/waldol1/fsl_groups/fslg_icdar/compute/BYU-AWESOME/scripts/jobscripts/nway.sh\n\n")
		out.write("dir=%s\n\n" % f)
		out.write("cp $script $dir\n")
		out.write("$dir/nway.sh 0 resume\n")
